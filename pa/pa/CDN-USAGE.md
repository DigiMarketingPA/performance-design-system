...
|---|---|
| `snippets/faq.html` | `css/modules/faq.css` |
| `snippets/hero.html` | `css/modules/hero.css` |
| `snippets/location-cards.html` | `css/modules/location-cards.css` |
| `snippets/deal-carousel.html` | `css/modules/deal-carousel.css` |
| `snippets/coupons.html` | `css/modules/coupons.css` |
